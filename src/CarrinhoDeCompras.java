public class CarrinhoDeCompras {
    ...
    public void adiciona(Livro livro) {
        ...
        livro.aplicaDescontoDe(0.16); // quando chamamos o método aplicaDescontoDe, ele vai verificar se o livro é um LivroFisico ou Ebook e aplicar o desconto correspondente.
